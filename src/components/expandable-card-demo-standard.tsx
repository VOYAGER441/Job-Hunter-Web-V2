        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100] p-4 sm:p-0">
            <motion.button
              ...
              className="flex absolute top-4 right-4 md:top-2 md:right-2 items-center justify-center bg-white dark:bg-neutral-800 rounded-full h-8 w-8 md:h-6 md:w-6 z-[110] shadow-lg"
                ...
                <div className="flex justify-between items-start p-4 sm:p-6">
                  <div className="min-w-0">
                    <motion.h3
                      ...
                      className="font-bold text-neutral-700 dark:text-neutral-200 text-lg md:text-xl truncate"
                    >
                      {active.title}
                    </motion.h3>
                    <motion.p
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-2 text-xs md:text-sm rounded-full font-bold bg-green-500 text-white shrink-0"
                  >
                    {active.ctaText}
                  </motion.a>
                </div>
        ...
        {cards.map((card, index) => (
          ...
          >
            <div className="flex gap-4 flex-col md:flex-row items-center md:items-start w-full">
              ...
              <div className="flex-1 min-w-0 text-center md:text-left">
                ...
                <motion.p
                  ...
                  className="text-neutral-600 dark:text-neutral-400 text-sm truncate"
                >
                  {card.description}
                </motion.p>
              </div>
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-bold bg-gray-100 dark:bg-neutral-800 hover:bg-green-500 hover:text-white text-black dark:text-neutral-300 mt-4 md:mt-0 shrink-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
